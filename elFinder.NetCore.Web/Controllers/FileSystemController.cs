...
namespace elFinder.NetCore.Web.Controllers
{
    ...
    public class FileSystemController : Controller
    {
        ...
        public async Task<IActionResult> Connector()
        {
            ...
            Task<IActionResult> a = connector.ProcessAsync(Request);
            await a;
            int b = 1;
        ...
        {
            var connector = GetConnector();
            Task<IActionResult> a = connector.GetThumbnailAsync(HttpContext.Request, HttpContext.Response, hash);
            await a;
            IActionResult b = await a;
            return b;
        }
